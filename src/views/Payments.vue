<template>
  <div class="p-4 md:p-12">
    <div class="grid grid-cols-3 gap-4 sm:px-5">
      <div class="col-span-3 sm:col-span-1 bg-gray-900 p-4">
        <div class="flex justify-between items-center">
          <h2
            class="text-sm md:text-sm text-gray-400 font-bold tracking-wide md:tracking-wider pl-1"
          >
            Banks
          </h2>
          <a
        ...
        <div class="space-y-3">
          ...
          <PaymentCard class="mt-6" name="ICICI Bank" amount="200" lastUsed="2" imageUrl="https://www.logotaglines.com/wp-content/uploads/2016/08/ICICI-Logo.png"/>
          <PaymentCard class="mt-6" name="Scotia Bank" amount="4500" lastUsed="78" imageUrl="https://play-lh.googleusercontent.com/GZXkzHxbRYGnehTg0ehjslPj4ummxV-oQklcE1Ba7hmq4zvBKfy2bR7zWEMOWqlcK6k"/>
          <PaymentCard class="mt-6" name="HSBC Bank" amount="680" lastUsed="6" imageUrl="https://icons.veryicon.com/png/o/business/online-payment/hsbc.png  "/>
      ...
      <div class="col-span-3 sm:col-span-1 bg-gray-900 p-4">
        ...
        <div class="space-y-3 mt-6">
          <CreditCard class="" lastDigits="7764"/>
          <CreditCard class="" lastDigits="3456"/>
        </div>
      </div>

      <div class="col-span-3 sm:col-span-1 bg-gray-900 p-4">
        <div class="flex justify-between items-center">
          <h2 class="text-xs md:text-sm text-gray-400 font-bold tracking-wide md:tracking-wider pl-1">
            Online Payments
          </h2>
          <a
            href="#"
...
export default {
  name: "Payments",
  components: {PaymentCard, CreditCard },
};
</script>
