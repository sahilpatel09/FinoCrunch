  ...
  <div>
    <header class="text-gray-600 body-font">
      ...
      >
        ...
        >
          <img src="../assets/logo-dark.png" class="w-14 h-14 p-2" alt="" />
          <span class="text-2xl">FinoCrunch</span>
        </a>
        <div class="lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0">
          <button
            class="inline-flex items-center bg-indigo-700 transition duration-300 border-0 py-1 px-3 focus:outline-none font-semibold hover:bg-indigo-500 text-white rounded text-base mt-4 md:mt-0"
          >
            Log in/ Register
            <svg
              fill="none"
    ...
    <section class="text-gray-600 body-font">
      ...
      >
        <img
          ...
          alt="hero"
          src="https://cdni.iconscout.com/illustration/premium/thumb/female-do-financial-management-2485631-2082087.png"
        />
        <div class="text-center lg:w-2/3 w-full">
          <h1
            class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900"
          >
            MicroWealth Management Solution is Here
          </h1>
          <p class="mb-8 leading-relaxed">
            Managing money can be complicated. Track all of your accounts in one
            place, collaborate with a partner, and create a long term plan to
            achieve your goals. Get personalized advice along the way.
          </p>
    ...
    <section class="text-gray-600 body-font">
      <div class="container px-5 py-24 mx-auto">
        <div class="text-center mb-20">
          ...
          >
            Money doesn’t have to be messy. The FinoCrunch wealth management app
            and its simple four-rule method will help you organize your
            finances, demolish your debt, save piles of cash, and reach your
    ...
    <section class="text-gray-600 body-font">
      <div class="container px-5 pt-24 mx-auto">
        <div class="flex flex-col text-center w-full mb-20">
          ...
          >
            Understand, Manage and Grow your NetWorth
          </h1>
          <p class="lg:w-2/3 mx-auto leading-relaxed text-base">
            There is a very good chance that, if you are reading this, you feel
            like you don’t have a handle on your finances, you are stressed
            about money, or need help digging out of debt. There are a whole
            slew of apps built on the premise of doing everything for you—and at
            first glance, this may seem appealing.
          </p>
        </div>
      </div>
      <div class="container px-5 mx-auto flex flex-wrap">
        <div class="flex flex-wrap w-full">
          ...
          <img
            ...
            src="https://kit8.net/wp-content/uploads/2020/12/money_from_monitor@2x.png"
            alt="step"
          />
        </div>
      </div>
    ...
    <section class="text-gray-600 body-font">
      <div class="container px-5 py-24 mx-auto">
        ...
        >
          What people are saying about FinoCrunch
        </h1>
        <div class="flex flex-wrap -m-4">
          <div class="p-4 md:w-1/2 w-full">
            <div class="h-full bg-gray-100 p-8 rounded">
              ...
              <p class="leading-relaxed mb-6">
                Love that I can easily see my net income by month across all of
                my accounts. Never been able to have this view before.
              </p>
          ...
          <div class="p-4 md:w-1/2 w-full">
            <div class="h-full bg-gray-100 p-8 rounded">
              ...
              <p class="leading-relaxed mb-6">
                I love FinoCrunch! Especially the cash flow and plan pages. I’ve
          ...
          <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
            ...
            >
              ...
              <p class="text-xs text-gray-500 mt-3">
                It is the best we can provide for free.
              </p>
            </div>
          </div>
          <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
    ...
    <footer class="text-gray-600 body-font">
      ...
      >
        ...
        >
          © {{ new Date().getFullYear() }} FinoCrunch | All Rights Reserved.
        </p>
        <span
