          ...
          <div class="flex flex-col space-y-6 md:h-full md:justify-between">
            <div class="flex justify-between">
                <span
                  ...
                  "
                >
                  <span class="text-black font-serif">Sahil Patel</span>
                    <br>
                  <br>
                  <span class="font-mono">Main Accounts</span>
                </span>
              <span
                  class="
                    text-xs text-gray-500
        ...
        >
          <div class="flex flex-col">
            <p class="text-white text-4xl font-bold">Networth</p>
              ...
              <div class="flex gap-2 md:gap-4 justify-between items-center border-2 p-4 mt-4 rounded">
                <div class="flex flex-col space-y-4">
                  <h2
                      class="
                        text-gray-800
              ...
              <div class="flex gap-2 md:gap-4 justify-between items-center border-2 p-2 mt-4">
                <div class="flex flex-col space-y-4">
                  <h2
                      class="
                        text-gray-800
