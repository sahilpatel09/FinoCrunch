<template>
  <div class="flex flex-row items-center justify-center">
    <div class="">
      ...
      <div class="flex flex-col rounded items-center justify-center px-16 py-14
       sm:shadow-2xl sm:rounded">
      ...
      <button class="mt-4 border-2 border-sky-500 px-8 py-2 flex flex-row items-center gap-2 rounded w-64 md:hover:bg-gray-100 md:ease-in md:duration-300">
...
<!--       <button class="mt-1 border-2 border-slate-900 px-8 py-2 flex flex-row items-center gap-2 w-64">
      ...
      <div class="flex flex-row gap-x-2 items-center justify-center mt-4">
        <div class="w-24 h-0.5 bg-indigo-100">
        </div>
        <div class="text-sm">
          or
        </div>
      ...
      <input type="email" name="email" class="w-64 border-2 p-2 rounded mt-4 focus:border-amber-400" placeholder="Email address or username" />
      <input type="password" name="password" class="w-64 border-2 p-2 rounded mt-1" placeholder="Password" />

      <button class="bg-indigo-500 text-white w-64 p-2 mt-2 rounded md:hover:bg-indigo-600 md:ease-in md:duration-300">Continue</button>
